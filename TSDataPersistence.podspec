...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Hongli183"
  # s.authors            = { "Hongli183" => "261930323@qq.com" }
  # s.social_media_url   = "http://twitter.com/Hongli183"
...
s.ios.deployment_target = '8.0'
  ...
  s.source_files  = "TSDataPersistence/DataPersistenceTool/*.{swift,md}"
